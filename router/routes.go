...
var API = map[string]Routes{
	"/players": Routes{
		...
		Route{
			...
			[]string{"playerlist.rangebool", "playerlist.rangebool.cursor"},
			[]string{"/list/{rangebool:0|1}/", "/list/{rangebool:0|1}/{cursor}/"},
			"GET",
			jsonheader,
	...
	"/clans": Routes{
		...
		Route{
			...
			[]string{"clanlist.rangebool", "clanlist.rangebool.cursor"},
			[]string{"/list/{rangebool:0|1}/", "/list/{rangebool:0|1}/{cursor}/"},
			"GET",
			jsonheader,
			clan.GetClanList,
			nil,
			utils.JSONResult{Result: clan.ClanList{Cursor: "send to get next page",
